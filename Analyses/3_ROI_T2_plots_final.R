...
## Define outdir
outdir <- "/home1/michel/projects/TBI/analyses/output_T2_final/"
dir.create(outdir)
...
plot <- ggplot( data = df.merged[df.merged$Metric=="t2" & df.merged$variable!="cp",], aes( x = Timepoint, y = value, 			group = Class, fill = Class, color = Class ) ) +

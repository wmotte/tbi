...
function REGimages ( $indir, $outputdir, $subject )
{
    ...
    // inputs
	$rois = "$outputdir/$subject/regs/tbirois2FA_nonl.nii.gz";
...
$se = $cog+30;
      ...
      
    {
       ...
       system("colormap -b $FA --nm -c 4 --ss $ss --se $se --sk 4 --sf 3 -d 1 -o $outputFA");
	system("colormap -b $ref --nm -c 4 --ss $ss --se $se --sk 4 --sf 3 -d 1 -o $outputref");
        system("colormap -b $bet -i $rois --int 0 -l "."colorcube"." --nm -c 4 --ss $ss --se $se --sk 4 --sf 3 -d 1 -o $outputrois");

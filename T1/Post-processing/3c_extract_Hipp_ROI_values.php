...
####
# Function to extract T1 values of new Hippocampus ROI
##
function ROIvals( $indir, $outdir, $subject )
{
    echo "*** Calculate mean T1 for Hippocampus of rat: $subject \n";
	...
	$T1out = "$outdir/ROI_values/Hipp-t1values.txt";
	$labels = "$outdir/regs/Hipp2T1.nii.gz";

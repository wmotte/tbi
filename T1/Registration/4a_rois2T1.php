...
####
# Warp the TBI ROIs reference image to subject T1 image. 
##
foreach( $rats as $subject )
{  

$warp = "$outputdir/$subject/regs/ref2T1_nonl.coef.nii.gz";
$input = "/home1/michel/projects/TBI/atlas/atlas_TBI_DTI_20190424.nii.gz";
$output = "$outputdir/$subject/regs/rois2T1.nii.gz";
...
$mask = "$outputdir/$subject/mask_adjusted.nii.gz";
        ...
        if( (!file_exists( "$outputdir/$subject/regs/rois2T1.nii.gz" ) ) | true )

...
## Select only mild + moderate TBI
df.select <- merge6[merge6$Class!="Control",]
...
write.table(df.select, "/home1/michel/projects/TBI/analyses/data/logistic_data_TBI.csv", sep=";", dec=",", row.names=FALSE)

...
## Select only controls + moderate TBI
df.select <- merge6[merge6$Class!="Mild",]
...
write.table(df.select, "/home1/michel/projects/TBI/analyses/data/logistic_data_moderate.csv", sep=";", dec=",", row.names=FALSE)

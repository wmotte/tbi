...
####
# Function to extract T2 values of Hippocampus ROIs
##
function ROIvals( $indir, $outdir, $subject )
{
    echo "*** Calculate mean T2 for Hippocampus of rat: $subject \n";
	...
	$T2out = "$outdir/ROI_values/Hipp-t2values.txt";
	$labels = "$outdir/regs/Hipp2T2.nii.gz";

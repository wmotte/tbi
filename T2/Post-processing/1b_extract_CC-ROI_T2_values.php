...
####
# Function to extract T2 values of CC ROIs
##
function ROIvals( $indir, $outdir, $subject )
{
    echo "*** Calculate mean T2 for CC of rat: $subject \n";
	...
	$T2out = "$outdir/ROI_values/CC-t2values.txt";
	$labels = "$outdir/regs/CC2T2.nii.gz";

...
function FCimages ( $indir, $outputdir, $subject, $processdir )
{
    ...
    // inputs
	$FC = "$outputdir/$subject/fc/fcmap_CPU_AFNI_filtered_mc_regressed.nii.gz";
	$FC2 = "$outputdir/$subject/fc-alt/fcmap_CPU_AFNI_filtered_mc_regressed.nii.gz";

    // output
    $outdir = "$processdir/FC-maps_CPU_checks_z-direction/";

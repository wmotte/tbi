...
## Loop over rats
	...
	$Dir = "$outputdir/$rat/";
	    ...
	    system("fslmaths $Dir/regs/rois2rs-fmri-tSNR10-masked.nii.gz -thr 3 -uthr 3 $Dir/fc/fcmap_roi.nii.gz");
		...
		$roi = "$Dir/fc/fcmap_roi.nii.gz";
		$output1 = "$Dir/fc/fcmap_AFNI_filtered_mc_regressed.nii.gz";
		$output2 = "$Dir/fc-alt/fcmap_AFNI_filtered_mc_regressed.nii.gz";
